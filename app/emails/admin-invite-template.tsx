...
export function AdminInviteTemplate({
  ...
  return (
    <Html>
      <Head />
      <Preview>You have been invited to the HMS Admin dashboard</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Section style={styles.section}>
            <Heading style={styles.heading}>Welcome to HMS Admin</Heading>
            <Text style={styles.text}>
              Hi <strong>{adminName}</strong>,
            </Text>
            <Text style={styles.text}>
              You have been invited to manage the HMS dashboard for{" "}
              <strong>{adminEmail}</strong>. Use the credentials below to sign
              in for the first time. You will be asked to reset your password
              on first login.
            </Text>

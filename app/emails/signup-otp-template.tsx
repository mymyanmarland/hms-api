...
export function SignupOtpTemplate({ otpCode, userEmail }: SignupOtpProps) {
  return (
    <Html>
      <Head />
      <Preview>Confirm your HMS Booking account</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Section style={styles.section}>
            <Heading style={styles.heading}>HMS Booking</Heading>
            <Text style={styles.brand}>Confirm your account</Text>
            <Text style={styles.text}>
              Welcome! Please confirm your email address{" "}
              <strong>{userEmail}</strong> to activate your HMS Booking account.
            </Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.warning}>
              If you did not create an HMS Booking account, please ignore this
